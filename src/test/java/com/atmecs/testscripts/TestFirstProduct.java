...
public class TestFirstProduct extends TestBase {
	...
	static String actualhomepage,actualstock,productprice,actualextax,actualdescription,actualsubtotal,actualecotax,actualvat;
	...
	public void testingDemoPage(String firstproduct,String quantity) throws Exception {
